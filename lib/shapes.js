...
`;
      textX = 150;
      textY = 100;
      // Make the font-size smaller to fit inside the triangle better
      fontSize = "20px";
      break;
    case "Square":
...
`;
      ...
      break;
    default:
      shapeSVG = ""; // Handle an unsupported shape
  }

  return `<svg width="300" height="200" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg">
  ${shapeSVG}
  <text x="${textX}" y="${textY}" font-size="${fontSize}" fill="white" text-anchor="middle" dominant-baseline="middle">${answers.text}</text>
</svg>
`;
};
